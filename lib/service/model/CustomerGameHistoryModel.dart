...
class CustomerGameHistoryModel {
  ...
  CustomerGameHistoryModel.fromJson(dynamic json) {
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
  ...
  String? _message;
  String? _serviceTime;
CustomerGameHistoryModel copyWith({  List<Data>? data,
  String? success,
  String? message,
  String? serviceTime,
}) => CustomerGameHistoryModel(  data: data ?? _data,
...
/// register_on : "2024-05-28 10:48:12"
/// is_delete : "0"
/// is_favorite : "1"
/// is_cancel : "0"
/// reposted : "0"
