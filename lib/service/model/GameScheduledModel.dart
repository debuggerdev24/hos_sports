...
/// data : [{"schedule_id":"2300","user_id":"3","team_name":"deee","rink":"Toronto","address":"Toronto, ON, Canada","gender":"Male","format":"Game - 5 vs 5","caliber":"A","goalies":"1","playoff":"1","save_game":"0","latitude":"43.653225","longitude":"-79.383183333333","game_payment":"50","date":"2024-05-17","time":"01:08 PM","game_datetime":"2024-05-17 13:08:00","time_zone":"Atlantic/Reykjavik","digit_timezone":"00:00","short_time_zone":"GMT","game_duration":"60","instruction":"","remainder":"0","place_id":"ChIJpTvG15DL1IkRd8S0KlBVNTI","register_on":"2024-05-17 07:40:17","is_delete":"0","is_favorite":"1","is_cancel":"0","reposted":"0","cancel_goalie_id":"0","parent_schedule_id":"-1","user_time_zone":"America/Toronto","cust_interest_id":"981","customer_id":"2","approval_status":"1","play_game":"0","check_in":"0","additional_game":"0","select_goalie_cut":"15","added_on":"2024-05-17 08:46:09","goalie_cut":"15","total_goalies":"1","total_time":"2024-05-17 14:08:00","cur_time":"2024-05-17 08:51:52","firstname":"Admin"}]
/// success : "1"
/// message : "Goalies all schedule"
/// service_time : "0.0067870616912842 seconds"

GameScheduledModel gameScheduledModelFromJson(String str) =>
    GameScheduledModel.fromJson(json.decode(str));
String gameScheduledModelToJson(GameScheduledModel data) =>
    json.encode(data.toJson());

class GameScheduledModel {
  GameScheduledModel({
    List<Data>? data,
    String? success,
    String? message,
  ...
  GameScheduledModel.fromJson(dynamic json) {
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
...
/// date : "2024-05-17"
/// time : "01:08 PM"
/// game_datetime : "2024-05-17 13:08:00"
...
/// register_on : "2024-05-17 07:40:17"
/// is_delete : "0"
/// is_favorite : "1"
/// is_cancel : "0"
/// reposted : "0"
...
/// added_on : "2024-05-17 08:46:09"
/// goalie_cut : "15"
/// total_goalies : "1"
/// total_time : "2024-05-17 14:08:00"
/// cur_time : "2024-05-17 08:51:52"
/// firstname : "Admin"
...
class Data {
  ...
  Data.fromJson(dynamic json) {
    ...
    _totalGoalies = json['total_goalies'];
  ...
  Data copyWith({
    ...
    String? firstname,
      ...
      Data(
        ...
        totalGoalies: totalGoalies ?? _totalGoalies,
  ...
  String? get totalGoalies => _totalGoalies;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['total_goalies'] = _totalGoalies;
